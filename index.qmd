...
Additionally, since the times at which the tweets were posted are included in the dataset, we plot them, progressively focusing on the date of the presidential election, to have a look at the patterns.
